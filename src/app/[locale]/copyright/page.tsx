...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Gears of War E-Day Wiki',
    description: 'Copyright and intellectual property information for Gears of War E-Day Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Gears of War E-Day Wiki',
      description: 'Copyright and intellectual property information for Gears of War E-Day Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Gears of War E-Day Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Gears of War E-Day Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Gears of War E-Day Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>The Coalition</strong> - Creators of the Gears of War E-Day game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Gears of War E-Day</strong> - Trademark of the game developers</li>
              <li><strong>Gears of War E-Day Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Gears of War E-Day Wiki.
            </p>
            ...
            <p>
              ...
              Gears of War E-Day Wiki<br />
              Email: <a href="mailto:dmca@gears-of-war-e-day.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gears-of-war-e-day.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Gears of War E-Day Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Gears of War E-Day Wiki (gears-of-war-e-day.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@gears-of-war-e-day.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@gears-of-war-e-day.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@gears-of-war-e-day.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gears-of-war-e-day.wiki</a>
            </p>
            <p>
