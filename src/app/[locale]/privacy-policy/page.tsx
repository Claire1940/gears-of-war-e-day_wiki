...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Gears of War E-Day Wiki',
    description: 'Gears of War E-Day Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Gears of War E-Day Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Gears of War E-Day Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Valve Corporation (Steam) or the developers of Gears of War E-Day. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@gears-of-war-e-day.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@gears-of-war-e-day.wiki</a>
            </p>
            <p>
